...
public interface CrudRepository<T> {
    ...
    public default Set<T> selectAll() throws JPAException{
        return new LinkedHashSet<>();
    }
    public abstract Optional<T> selectById(Long id) throws JPAException;
    public default Optional<T> selectByPropiedad(T t) throws JPAException{
        return Optional.empty();
    }
    public abstract void deleteById(Long id) throws JPAException;
